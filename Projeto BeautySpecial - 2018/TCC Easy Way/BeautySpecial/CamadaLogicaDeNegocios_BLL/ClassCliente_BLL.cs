...
namespace CamadaLogicaDeNegocios_BLL
{
    public class ClassCliente_BLL : IClassCliente_BLL
    {
        ...
        public string InserirCliente(ClassCliente_DTO classcliente_dto)
        {
            try
            {
               //Limpando Parametros
        ...
        //Metodo Atualizar
        public string AtualizarCliente(ClassCliente_DTO classcliente_dto)
        {
            try
            {
                //Limpando Parametros
        ...
        //Metodo Excluir
        public string ExcluirCliente(ClassCliente_DTO classcliente_dto)
        {
            try
            {
                //Limpando Parametros
