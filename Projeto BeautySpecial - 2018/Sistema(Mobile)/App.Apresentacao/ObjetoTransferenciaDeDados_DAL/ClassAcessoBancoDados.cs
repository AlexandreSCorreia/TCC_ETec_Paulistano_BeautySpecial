...
namespace ObjetoTransferenciaDeDados_DAL
{
    public class ClassAcessoBancoDados
    {
        ...
        {
            return new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=G:\ApresentaçãoTCCAtualizado\BancoDeDadosNovaVersão\BDBeautySpecial.mdf;Integrated Security=True;Connect Timeout=30");
